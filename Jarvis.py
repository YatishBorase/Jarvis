...
def wish_me():
    ...
    if hour>=0 and hour<12:
        speak("Good morning Yatish sir. What are you doing")
    
    elif hour>=12 and hour<18:
        speak("Good afternoon Yatish sir. What are you doing")

    else:
        speak("Good evening Yatish sir. What are you doing")
    
    speak("I am AI-BOT. Tell me sir What can i help you")
